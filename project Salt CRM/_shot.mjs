...
await page.screenshot({ path:P+'rail_open.png' })
await page.click('button[title="Replier le panneau"]')
await page.waitForTimeout(600)
await page.screenshot({ path:P+'rail_closed.png' })
console.log('kanban in body?', (await page.textContent('body')).includes('Kanban'))
await browser.close()
